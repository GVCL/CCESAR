...
model_natural = load_model(os.path.join(MODEL_SAVE_DIR,"UNet8-natural.h5"))
model_built = load_model(os.path.join(MODEL_SAVE_DIR,"UNet8-developed.h5"))
classification_model = model = keras.models.load_model(
   os.path.join(MODEL_SAVE_DIR,"8bit-classification.h5")
)
