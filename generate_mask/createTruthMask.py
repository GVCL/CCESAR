...
if __name__ == "__main__":
    for i in range(1,11):
        sar_image_path = rf"E:\all_coastline\github\CCESAR\1.tiff\1.tiff"
        shapefile_path = rf"E:\all_coastline\github\CCESAR\1.tiff\1.shp"
        output_image_path = rf"E:\all_coastline\github\CCESAR\1.tiff\1_mask.tiff"
